...
const selectedFeature = ref<SelectedFeature>({
  ...
  subtitle: 'เลือกคลังน้ำมัน ท่าเทียบเรือ หรือเส้นท่อบนแผนที่',
  data: {},
})
        ...
        <CardContent class="space-y-3 px-4 pb-4 pt-1">
          ...
          >
            ...
            <span class="min-w-0 flex-1 text-left">
              ...
              <small>แสดงตำแหน่งคลังบนแผนที่</small>
            </span>
          ...
          >
            ...
            <span class="min-w-0 flex-1 text-left">
              ...
              <small>แสดงจุดรับและขนถ่ายน้ำมัน</small>
            </span>
          ...
          >
            ...
            <span class="min-w-0 flex-1 text-left">
              ...
              <small>แสดงแนวเส้นทางท่อขนส่ง</small>
            </span>
