...
type KpiItem = {
  ...
  description: string
  icon: string
  tone: 'blue' | 'green' | 'violet' | 'purple' | 'orange' | 'cyan'
}
...
const rows: FuelRow[] = [
  { rank: '1.', group: 'น้ำมันดิบ', legalReserve: 7831.08, workingStock: 3037.91, totalStock: 10868.99, dailyDemand: 95.69, legalDays: 81.89, actualDays: 113.59 },
  { rank: '2.', group: 'น้ำมันเชื้อเพลิงระหว่างการขนส่ง', legalReserve: 1240.60, workingStock: 1319.00, totalStock: 2559.60, dailyDemand: 26.04, legalDays: 47.66, actualDays: 98.30 },
  { rank: '3.', group: 'น้ำมันสำเร็จรูป - รวม', legalReserve: 7036.78, workingStock: 17024.84, totalStock: 24061.62, dailyDemand: 348.07, legalDays: 20.20, actualDays: 69.11 },
  { rank: '3.1', group: 'กลุ่มที่ 1 น้ำมันเบนซิน', legalReserve: 1405.84, workingStock: 1274.44, totalStock: 2680.28, dailyDemand: 44.94, legalDays: 31.28, actualDays: 59.67 },
  { rank: '3.2', group: 'กลุ่มที่ 2 เอทานอล', legalReserve: 139.88, workingStock: 262.68, totalStock: 402.56, dailyDemand: 21.80, legalDays: 6.42, actualDays: 18.47 },
  { rank: '3.3', group: 'กลุ่มที่ 3 น้ำมันดีเซลหมุนเร็ว', legalReserve: 3431.55, workingStock: 11116.34, totalStock: 14547.89, dailyDemand: 192.30, legalDays: 17.85, actualDays: 75.66 },
  { rank: '3.4', group: 'กลุ่มที่ 4 ไบโอดีเซล', legalReserve: 15.89, workingStock: 56.82, totalStock: 72.71, dailyDemand: 2.97, legalDays: 5.35, actualDays: 24.46 },
  { rank: '3.5', group: 'กลุ่มที่ 5 น้ำมันเตา ชนิดที่ 1', legalReserve: 437.84, workingStock: 1487.00, totalStock: 1924.84, dailyDemand: 21.71, legalDays: 20.16, actualDays: 88.68 },
  { rank: '3.6.', group: 'อากาศยาน', legalReserve: 528.60, workingStock: 1196.40, totalStock: 1725.00, dailyDemand: 18.90, legalDays: 27.97, actualDays: 91.27 },
  { rank: '10.', group: 'ก๊าซปิโตรเลียมเหลว', legalReserve: 198.40, workingStock: 462.10, totalStock: 660.50, dailyDemand: 16.20, legalDays: 12.25, actualDays: 40.77 },
  { rank: '11.', group: 'กลุ่ม 9', legalReserve: 211.75, workingStock: 488.35, totalStock: 700.10, dailyDemand: 12.40, legalDays: 17.08, actualDays: 56.46 },
  { rank: '12.', group: 'กลุ่ม 10', legalReserve: 92.10, workingStock: 205.60, totalStock: 297.70, dailyDemand: 8.70, legalDays: 10.59, actualDays: 34.22 },
  { rank: '13.', group: 'กลุ่ม 11', legalReserve: 140.20, workingStock: 350.40, totalStock: 490.60, dailyDemand: 11.80, legalDays: 11.88, actualDays: 41.58 },
  { rank: '14.', group: 'ผลิตภัณฑ์อื่น', legalReserve: 129.50, workingStock: 98.90, totalStock: 228.40, dailyDemand: 6.30, legalDays: 20.56, actualDays: 36.25 },
]

const chartData: ChartItem[] = [
  { name: 'น้ำมันดิบ', legalReserve: 7831.08, workingStock: 3037.91, totalStock: 10868.99, legalDays: 81.89, actualDays: 113.59 },
  { name: 'ระหว่างขนส่ง', legalReserve: 1240.60, workingStock: 1319.00, totalStock: 2559.60, legalDays: 47.66, actualDays: 98.30 },
  { name: 'เบนซิน', legalReserve: 1405.84, workingStock: 1274.44, totalStock: 2680.28, legalDays: 31.28, actualDays: 59.67 },
  { name: 'เอทานอล', legalReserve: 139.88, workingStock: 262.68, totalStock: 402.56, legalDays: 6.42, actualDays: 18.47 },
  { name: 'ดีเซลหมุนเร็ว', legalReserve: 3431.55, workingStock: 11116.34, totalStock: 14547.89, legalDays: 17.85, actualDays: 75.66 },
  { name: 'ไบโอดีเซล', legalReserve: 15.89, workingStock: 56.82, totalStock: 72.71, legalDays: 5.35, actualDays: 24.46 },
  { name: 'เตา ชนิดที่ 1', legalReserve: 437.84, workingStock: 1487.00, totalStock: 1924.84, legalDays: 20.16, actualDays: 88.68 },
  { name: 'เตา ชนิดที่ 2', legalReserve: 320.00, workingStock: 1100.00, totalStock: 1420.00, legalDays: 18.60, actualDays: 76.00 },
  { name: 'อากาศยาน', legalReserve: 528.60, workingStock: 1196.40, totalStock: 1725.00, legalDays: 27.97, actualDays: 91.27 },
  { name: 'ก๊าซ', legalReserve: 198.40, workingStock: 462.10, totalStock: 660.50, legalDays: 12.25, actualDays: 40.77 },
  { name: 'ทหาร', legalReserve: 290.00, workingStock: 840.00, totalStock: 1130.00, legalDays: 35.78, actualDays: 160.00 },
  { name: 'กลุ่ม 9', legalReserve: 211.75, workingStock: 488.35, totalStock: 700.10, legalDays: 17.08, actualDays: 56.46 },
  { name: 'กลุ่ม 10', legalReserve: 92.10, workingStock: 205.60, totalStock: 297.70, legalDays: 10.59, actualDays: 34.22 },
  { name: 'กลุ่ม 11', legalReserve: 140.20, workingStock: 350.40, totalStock: 490.60, legalDays: 11.88, actualDays: 41.58 },
]

const kpis: KpiItem[] = [
  { title: 'ปริมาณสำรองตามกฎหมาย', value: '16,823,300', suffix: 'ลบม.', description: 'มาตรฐานขั้นต่ำ', icon: 'i-lucide-shield-check', tone: 'blue' },
  { title: 'ปริมาณสำรองทางการค้า', value: '23,381,743', suffix: 'ลบม.', description: 'Total Stock - Legal Reserve', icon: 'i-lucide-database', tone: 'green' },
  { title: 'ปริมาณน้ำมันคงเหลือ', value: '40,205,043', suffix: 'ลบม.', description: 'รวมทุกกลุ่มน้ำมัน', icon: 'i-lucide-droplets', tone: 'violet' },
  { title: 'ความต้องการใช้เฉลี่ยต่อวัน', value: '470,185', suffix: 'ลบม./วัน', description: 'ความต้องการเฉลี่ยรวม', icon: 'i-lucide-chart-no-axes-combined', tone: 'purple' },
  { title: 'จำนวนวันที่ใช้ได้ตามกฎหมาย', value: '35.78', suffix: 'วัน', description: 'ขั้นต่ำตามกฎหมาย', icon: 'i-lucide-calendar-days', tone: 'orange' },
  { title: 'จำนวนวันที่ใช้ได้จริง / รวม', value: '85.49 / 97.13', suffix: 'วัน', description: 'เฉลี่ยคงเหลือ / สูงสุด', icon: 'i-lucide-clock-3', tone: 'cyan' },
]
...
const legalPoints = computed(() => chartData.map((item, index) => {
  const x = 38 + index * (860 / (chartData.length - 1))
  ...
  <div class="fuel-stock-dashboard w-full min-w-0 space-y-3">
    ...
    <section class="grid min-w-0 gap-3 xl:grid-cols-2">
      <Card class="min-w-0 gap-0 rounded-2xl border-border/80 py-0 shadow-sm">
        <CardHeader class="px-4 pb-2 pt-4">
          <CardTitle class="text-base">
            เปรียบเทียบปริมาณสำรองและปริมาณคงเหลือ จำแนกตามกลุ่มน้ำมัน
          </CardTitle>
      ...
      <Card class="min-w-0 gap-0 rounded-2xl border-border/80 py-0 shadow-sm">
        <CardHeader class="px-4 pb-2 pt-4">
          <CardTitle class="text-base">
            จำนวนวันที่ใช้ได้ จำแนกตามกลุ่มน้ำมัน
          </CardTitle>
          ...
          <div class="line-chart-scroll">
            <div class="line-chart-wrap">
              <svg viewBox="0 0 940 230" preserveAspectRatio="none" class="line-chart" role="img" aria-label="กราฟจำนวนวันที่ใช้ได้">
                <g class="grid-lines">
                  <line v-for="tick in [0, 30, 60, 90, 120, 150, 180]" :key="tick" x1="38" x2="900" :y1="18 + (1 - tick / maxDays) * 182" :y2="18 + (1 - tick / maxDays) * 182" />
                </g>
                ...
                <circle
                  ...
                  :key="`legal-${item.name}`"
                  :cx="38 + index * (860 / (chartData.length - 1))"
    ...
    <Card class="min-w-0 gap-0 overflow-hidden rounded-2xl border-border/80 py-0 shadow-sm">
      <CardHeader class="px-4 pb-3 pt-4">
        <div class="flex flex-wrap items-start justify-between gap-3">
          <div>
            <CardTitle class="text-base">
              สรุปปริมาณน้ำมันเชื้อเพลิงคงเหลือและจำนวนวันที่ใช้ได้ จำแนกตามกลุ่มน้ำมัน
            </CardTitle>
...
.kpi-tone-cyan { background: color-mix(in oklab, #0891b2 12%, var(--card)); color: #0891b2; }
...
.line-chart-wrap { position: relative; min-width: 940px; }
...
.line-labels { display: grid; min-width: 940px; grid-template-columns: repeat(14, minmax(50px, 1fr)); padding: 0 0.3rem; color: var(--muted-foreground); text-align: center; font-size: 0.58rem; line-height: 1.1; }
