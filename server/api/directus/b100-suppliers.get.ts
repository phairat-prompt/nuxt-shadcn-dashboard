...
export default defineCachedEventHandler(async () => {
  ...
  const result = await $fetch<DirectusItemsResponse>(`${directusUrl}/items/b100_suppliers`, {
    method: 'GET',
    headers: {
    ...
    query: {
      ...
      fields: [
        ...
        'lon',
        'supplier_name',
        'daily_production_capacity_liters',
        'production_capacity_lpd',
      ].join(','),
