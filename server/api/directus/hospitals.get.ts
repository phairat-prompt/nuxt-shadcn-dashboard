...
export default defineCachedEventHandler(async () => {
  ...
  const result = await $fetch<DirectusItemsResponse>(`${directusUrl}/items/longdo_hospital`, {
    method: 'GET',
    headers: {
